...
class Worker : public QObject {
    Q_OBJECT
public:
    Worker(QObject *parent = nullptr) : QObject(parent), m_stopRequested(false), m_inRetryPhase(false), m_vpnTag("") {}
